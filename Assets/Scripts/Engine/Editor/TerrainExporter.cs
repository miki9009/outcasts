...
class ETerrainExporter : EditorWindow
{
    ...
    static void Init()
    {
        ...
        EditorWindow.GetWindow<ETerrainExporter>().Show();
    }
    ...
    void OnGUI()
    {
        if (!terrain)
        {
            ...
            {
                EditorWindow.GetWindow<ETerrainExporter>().Close();
            }
            return;
        }
